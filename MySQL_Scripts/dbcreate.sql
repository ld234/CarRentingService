...
REGO VARCHAR(6) NOT NULL, /* LICENSE NUMBER */
FIRSTNAME VARCHAR(20) NOT NULL,
LASTNAME VARCHAR(20) NOT NULL,
...
CREATE TABLE NOTIFICATION (
    ...
    CONSTRAINT NOTIF_FK FOREIGN KEY (RECEIVER) REFERENCES USER(USERNAME)
);
...
CREATE TABLE REVIEW (
    ...
    CONSTRAINT REVIEW_FK2 FOREIGN KEY (REVIEWER) REFERENCES CARRENTER(USERNAME)
);
